        ...
        <input
          ...
          >
            ...
            <div className=" flex flex-col gap-6 w-[100%] md:justify-end max-sm:mt-5  pr-[2rem] ">
                ...
                <br className=""/>Our dedicated team is here to help you with prompt and reliable support. <br className="md:hdden max-sm:flex "/>Reach out to us today!  
                </p>

                <div className="flex md:justify-start  flex-col gap-5 ">
                  <div className="flex md:flex-row sm:flex-row  max-xs:flex-col md:justify-center gap-[1rem] ">
