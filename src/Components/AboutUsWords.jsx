    ...
    <div className=" flex flex-col text-word gap-8 relative ">
      ...
      <div className="flex  flex-col gap-8 animate-slide-in-right max-xs:p-3">
        <div className="flex  justify-center ">
            <h1 className="text-[32px] font-600  leading-[200%] font-sora  xxs:pr-[3rem] xxs:pl-[1rem] ">About PrimeLabs</h1>
        </div>
      
        <div  className="flex  justify-center ">
        <p className=" text-[20px] font-400 leading-[200%] font-sora sm:pl-[1rem] xxs:pr-[3rem] xxs:pl-[1rem]  " >
        Empowering Businesses with Innovative Software Solutions, Driving Success, and Enabling Growth through Technology Excellence.
        </p>
      </div>
