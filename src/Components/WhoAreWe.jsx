...
const WhoAreWe = () => {
  ...
  return (
    <div>
      <div
        className='flex flex-row md:pl-[2rem]  gap-[0rem] w-[100%] h-[400px]  hover-effect-box  sm:w-[100%] max-xs:w-[100%] max-xs:w-[350px] md:p-0 bg-word rounded-[10px] pl-[2rem] sm:pl-[1rem] max-xs:pl-[2rem] relative  animate-slide-in-left'
