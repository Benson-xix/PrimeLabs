  ...
  return (
    <div>
          <div className="  flex flex-row max-sm:flex-col bg-ind mt-[2rem]  justify-center  max-md:gap-[1rem] max-md:p-1 ">
            ...
            <p className="text-Black text-[16px] max-sm:text-[14px] md:justify-start lg-[180%] md:w-[90%] sm:w-[180%] sm:flex sm:justify-center font-400 font-sora leading-[32px] max-xs:pl-[.5rem] max-xs:pr-[1rem] max-xs:w-[90%] ">
