    ...
    <div className="flex flex-row xl:gap-[12rem] sm:gap-[3rem] max-xs:gap-[3rem]   lg:grid xl:grid-cols-3 lg:grid-cols-2 md:grid md:grid-cols-2 max-sm:flex-col  ">
      ...
      <div className="xl:w-[170%] md:w-[90%] sm:w-[50%] max-xs:w-[90%]   h-[650px] hover-effect-box bg-word shadow-lg flex flex-col gap-[3rem]  pt-7 pl-9  ">
        ...
        <div className=" flex flex-row gap-5 ">
         ...
         <p className=" text-Black text-[20px] leading-[120%] font-400 font-sora ">PHP</p>
        </div>
        ...
        <div className="flex  ">
            <button className="bg-start hover:bg-start-dark rounded-[10px] lg:w-[227px] md:w-[200px] max-sm:w-[200px] font-sora  h-[40px] flex justify-center text-word leading-[20px] font-semibold text-[16px] pt-2   ">Read More</button>
        </div>
        ...
        <div className="flex ">
            <button className="bg-start hover:bg-start-dark rounded-[10px] font-sora lg:w-[227px] md:w-[200px] max-sm:w-[200px] h-[40px] flex justify-center text-word leading-[20px] font-semibold text-[16px] pt-2   ">Read More</button>
        </div>
      ...
      <div className="xl:w-[170%] md:w-[90%] sm:w-[50%] max-xs:w-[90%] h-[650px] max-xs:mt-[3rem] bg-word hover-effect-box shadow-lg  flex flex-col gap-[3rem]  pt-7 pl-9  xl:mt-0 lg:mt-5 ">
        ...
        <div className="flex mt-12 ">
            <button className="bg-start hover:bg-start-dark rounded-[10px] lg:w-[227px] md:w-[200px] font-sora max-sm:w-[200px]  h-[40px] flex justify-center text-word leading-[20px] font-semibold text-[16px] pt-2   ">Read More</button>
        </div>
