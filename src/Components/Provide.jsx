...
const Provide = () => {
  ...
  return (
    <div className=' w-[100%] md:p-[1rem] lg:p-[1rem] mt-7 xxs:pl-[.2rem] '>
   <div className='flex flex-row'> <h3 className='font-600 text-[40px] leading-[160%] text-Black border-b-[.3rem] border-Gold font-sora '>In</h3>
    ...
    <h4 className=' font-400 text-[24px] text-Black leading-[200%] max-xs:text-[18px] font-sora  xxs:pr-[7rem] '>We Make Almost Every Genre Of Application, You Name it And We Build it</h4>
