...
const Goals = () => {
  return (
    ...
    <div className="  h-[100%]  md:flex  hover-effect-box  ">
        <img src={Hands} alt="Hands" className=" w-[550px] h-[377px] max-xs:w-[300px] max-xs:h-[200px]  " />
    </div>
    </div> 
    ...
    <div className="  h-[100%]  md:flex  hover-effect-box lg:hidden md:hidden sm:hidden max-xs:visible ">
        <img src={Gathering} alt="Hands" className=" w-[550px] h-[377px] max-xs:w-[300px] max-xs:h-[200px]  " />
    </div>
    </div></div>
  )
}
