...
const Discover = () => {
  return (
    <div className="mt-[6rem] flex flex-col text-word gap-8 relative ">
      <div className="flex justify-center xxs:pr-[4rem] ">
      ...
      <div className="flex  flex-col gap-8 animate-slide-in-right max-xs:p-3">
        <div className="flex  justify-center ">
            <h1 className="text-[32px] font-600  leading-[200%] font-sora  xxs:pr-[6rem] ">Invest Today, Secure Your Tomorrow</h1>
        </div>
      
      <div  className="flex  justify-center ">
        <p className=" text-[20px] font-400 leading-[200%] font-sora sm:pl-[1rem] xxs:pr-[3rem]  " >
      ...
      <div className="flex justify-center  xs:p-3 xxs:pr-[5rem]  ">
